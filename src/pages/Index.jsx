            ...
            <Tr>
              ...
              {players.map((player, playerIndex) => (
                <Td key={playerIndex} isNumeric>
                  <Input type="number" value={player.scores[currentHole] === 0 ? "" : player.scores[currentHole]} onChange={(e) => handleScoreChange(playerIndex, currentHole, e.target.value)} size="sm" max={9} min={0} bg={currentHole === currentHole ? "yellow.100" : "transparent"} color={currentHole === currentHole ? "black" : "gray.500"} fontStyle={currentHole === currentHole ? "normal" : "italic"} />
                </Td>
              ))}
            </Tr>
            <Tr>
